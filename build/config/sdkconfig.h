...
#define CONFIG_FATFS_USE_STRFUNC_WITH_CRLF_CONV 1
#define CONFIG_FATFS_PRINT_FLOAT 1
#define CONFIG_FATFS_STRF_ENCODE_UTF8 1
...
#define CONFIG_CAMERA_OV5647_MIPI_IF_FORMAT_INDEX_DAFAULT 3
